...
for x in range(0, 800 , 100):
    for y in range(0, 80, 30):
        ...
        brick2.pos = [x,y]
        all_briks1.append(brick2)

for x in range(0, 800 , 100):
    for y in range(30, 80, 30):
        brick1 = Actor("brick1",anchor = ["left","top"])
        brick1.pos = [x,y] 
        all_briks1.append(brick1)
       



msg = Actor("finish", anchor = ["left","top"])
msg.pos = [0,0]
player = Actor("player")
player.pos = [400,550] 
...
def update():
    ...
    for brick in reversed(all_briks1):
